...
class nodeneutron {
       file {  '/etc/sysctl.conf':
        mode => 755,
        source => 'puppet:///extra_files/node/sysctl.conf',
	ensure => 'file',
	}
	...
	refreshonly => true,
       ...
       file {  '/etc/neutron/metadata_agent.ini':
        mode => 755,
        source => 'puppet:///extra_files/node/metadata_agent.ini',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/etc/neutron/dhcp_agent.ini':
        mode => 755,
        source => 'puppet:///extra_files/node/dhcp_agent.ini',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/etc/neutron/l3_agent.ini':
        mode => 755,
        source => 'puppet:///extra_files/node/l3_agent.ini',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/etc/neutron/plugins/ml2/linuxbridge_agent.ini':
        mode => 755,
        source => 'puppet:///extra_files/node/linuxbridge_agent.ini',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/etc/neutron/plugins/ml2/ml2_conf.ini':
        mode => 755,
        source => 'puppet:///extra_files/node/ml2_conf.ini',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/etc/neutron/neutron.conf':
        mode => 755,
        source => 'puppet:///extra_files/node/neutron.conf',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
       file {  '/root/neutronch.sh':
        mode => 755,
        source => 'puppet:///extra_files/node/neutronch.sh',
	ensure => 'file',
	}
       file {  '/root/neutronch2.sh':
        mode => 755,
        source => 'puppet:///extra_files/node/neutronch2.sh',
	ensure => 'file',
        subscribe => Exec['dummyrun'],
	}
	exec { 'neutronch':
